module.exports = {
  ...
  rules: {
    ...
    "valid-jsdoc": [2, { // jsdoc规则 https://eslint.org/docs/rules/valid-jsdoc
    ...
    'no-irregular-whitespace': 2, // 禁止不规则空格（无不规则空格）
    ...
    'space-before-function-paren': [2, 'never'], // 函数括号前需要或不允许空格（space-before-function-paren）
